...
void attention_forward_kernel_launcher(const __half* X,const __half* W_phi,
                                       const __half* gate_q,const __half* gate_k,
                                       const __half* W_V,__half* out,
                                       const int B,const int N,const int D,const int H,
                                       const int cube_m,const int head_dim_v,
                                       cudaStream_t stream);
